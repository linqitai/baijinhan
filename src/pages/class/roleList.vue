...
<template>
  <div class="apply" ref="apply">
    <div class="breadcrumbWrapper">
      <div class="breadcrumb">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item><span class="nocurrent">角色</span></el-breadcrumb-item>
      ...
      <el-table :data="tableData" border style="width: 100%"  v-loading="loading">
        ...
        <el-table-column prop="name" label="操作" width="200">
          <template slot-scope="scope">
            <el-button @click="operateBtn('edit',scope.row)" type="text" size="small" icon="el-icon-edit-outline">修改</el-button>
            <el-button @click="handleDeleteClick(scope.row)" type="text" size="small" icon="el-icon-close">删除</el-button>
            <el-button @click="setPermissionClick(scope.row)" type="text" size="small" icon="el-icon-edit-outline">设置权限</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :title="title" :visible.sync="dialogAddFormVisible" :append-to-body="true" :fullscreen="false" width="400">
    ...
    <el-dialog title="设置权限" :visible.sync="setPermissionDialog" :append-to-body="true" :fullscreen="true">
